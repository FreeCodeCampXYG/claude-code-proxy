...
func TestPlaygroundPageReflectsImplementedCapabilities(t *testing.T) {
	...
	for _, fragment := range []string{"window.__localPageToken=", "function escapeHtml", "function processFrame", "XMLHttpRequest", "xhr.timeout=120000", "ocrGeneration", "function cancelOcr", "pasteOcrImage", "ocrPreviewURL", "图片工作流", "OCR 识图", "PPT 创作", "ppt-outline/v1", "IMAGE_API_URL、IMAGE_API_KEY、IMAGE_MODEL", "function setImageState", "function cancelImage", "aria-live=\"polite\"", "image-card", "image-config"} {
